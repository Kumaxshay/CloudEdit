...
app.use(express.static(path.join(__dirname, "..", "..", "client", "dist"))) // Serve client static files
app.use(express.static(path.join(__dirname, "..", "public"))) // Serve server public files
...
app.get("*", (req: Request, res: Response) => {
	// Send the index.html file from client dist
